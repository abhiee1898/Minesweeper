...
class Minesweeper:
    ...
    def __init__(self, tk):
        ...
        self.labels["time"].grid(row=0, column=0, columnspan=10)  # top full width
        ...
        self.button = Button(self.frame, text="Restart", command=restart_button, padx=5, pady=5, bg="black",
                             fg="yellow")
        ...
        self.quitbutton = Button(self.frame, text="Quit", command=quit_button, padx=5, pady=5, bg="black", fg="red")
        self.quitbutton.grid(row=12, column=6, columnspan=5)
    ...
    def gameOver(self, won):
        ...
        res = messagebox.showinfo("Game Over", msg)
        if res:
            self.restart()
